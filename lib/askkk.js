...
AskKK = (function(){
   ...
   */
  prototype.ask = function(arg$){
    var title, candidates, description, candidatesRef;
    title = arg$.title, candidates = arg$.candidates, description = arg$.description;
    return candidatesRef = this._firebase.child('/candidates');
  };
  /**
